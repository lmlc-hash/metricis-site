            ...
            {!isAuthenticated ? (
                ...
                <>
                    ...
                    <button 
                        ...
                        className={`transition-colors ${currentPage === 'profile' ? 'text-primary' : 'text-gray-400 hover:text-secondary'}`}
           ...
           <nav className="flex flex-col space-y-2">
            {!isAuthenticated ? (
                ...
                <>
                    ...
                    <button onClick={() => handleNavClick('profile')} className={mobileNavLinkClass('profile')}>Profile & Settings</button>
